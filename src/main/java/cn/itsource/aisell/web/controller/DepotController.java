...
public class DepotController extends BaseController {
    ...
    public UiPage page(DepotQuery query){
        return new UiPage(depotService.findPageByQuery(query));
    }
     ...
     *
     */
    @ModelAttribute("editDepot")
    public Depot beforeEdit(Long id,String cmd){
    ...
    @ResponseBody
    public ResultJson update(@ModelAttribute("editDepot") Depot depot){
        return saveOrUpdate(depot);
    }

    private ResultJson saveOrUpdate(Depot depot){
