...
<table id="dataGrid" class="easyui-datagrid" style="width:400px;height:250px"
    ...
    <tr>
                    ...
                    <th data-options="field:'maxcapacity',width:100">maxcapacity</th>
                    <th data-options="field:'currentcapacity',width:100">currentcapacity</th>
...
<!-- 添加与修改的弹出框 -->
<div id="depotDialog" class="easyui-dialog" title="功能操作" style="width:280px;padding: 10px;"
     data-options="iconCls:'icon-save',modal:true,closed:true">
    <!-- 表单准备 -->
    <form id="editForm" action="" method="post">
        <input id="depotId" type="hidden" name="id" />
        <table>
                      <tr>
                <td>name:</td>
                <td><input name="name" class="f1 easyui-validatebox"></input></td>
                      ...
                      <tr>
                <td>maxcapacity:</td>
                <td><input name="maxcapacity" class="f1 easyui-validatebox"></input></td>
            </tr>
                      <tr>
                <td>currentcapacity:</td>
                <td><input name="currentcapacity" class="f1 easyui-validatebox"></input></td>
            </tr>
                      <tr>
                <td>totalamount:</td>
        ...
        <div style="text-align:center;padding:5px">
            ...
            <a href="#"  class="easyui-linkbutton" onclick="$('#depotDialog').dialog('close')" iconCls="icon-cancel">取消</a>
        </div>
    </form>
</div>
