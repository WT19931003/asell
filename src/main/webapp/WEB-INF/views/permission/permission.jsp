...
<table id="dataGrid" class="easyui-datagrid" style="width:400px;height:250px"
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'menuId',width:100">对应菜单</th>
        </tr>
    </thead>
</table>
<!-- 高级查询与按钮 -->
...
<!-- 添加与修改的弹出框 -->
<div id="permissionDialog" class="easyui-dialog" title="功能操作" style="width:280px;padding: 10px;"
    ...
    <form id="editForm" action="" method="post">
        ...
        <table>
                ...
                <td><input name="name" class="f1 easyui-validatebox"></input></td>
                      ...
                      <tr>
                <td>url:</td>
                <td><input name="url" class="f1 easyui-validatebox"></input></td>
            </tr>
                      <tr>
                <td>descs:</td>
                ...
                <td><input name="sn" class="f1 easyui-validatebox"></input></td>
                      ...
                      <tr>
                <td>menuId:</td>
                <td><input name="menuId" class="f1 easyui-validatebox"></input></td>
            </tr>
                  </table>
        <div style="text-align:center;padding:5px">
            <a href="#"  class="easyui-linkbutton" data-method="save" iconCls="icon-save">确定</a>
            <a href="#"  class="easyui-linkbutton" onclick="$('#permissionDialog').dialog('close')" iconCls="icon-cancel">取消</a>
        </div>
    </form>
</div>
