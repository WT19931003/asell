...
<!-- 添加与修改的弹出框 -->
<div id="producttypeDialog" class="easyui-dialog" title="功能操作" style="width:280px;padding: 10px;"
    ...
    <form id="editForm" action="" method="post">
        ...
        <div style="text-align:center;padding:5px">
            ...
            <a href="#"  class="easyui-linkbutton" onclick="$('#producttypeDialog').dialog('close')" iconCls="icon-cancel">取消</a>
        </div>
    </form>
</div>
