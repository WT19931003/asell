...
<!-- 添加与修改的弹出框 -->
<div id="systemdictionarydetailDialog" class="easyui-dialog" title="功能操作" style="width:280px;padding: 10px;"
    ...
    <form id="editForm" action="" method="post">
        ...
        <table>
                ...
                <td><input name="name" class="f1 easyui-validatebox"></input></td>
                      ...
                      <tr>
                <td>typesId:</td>
                <td><input name="typesId" class="f1 easyui-validatebox"></input></td>
            </tr>
                  </table>
        <div style="text-align:center;padding:5px">
            <a href="#"  class="easyui-linkbutton" data-method="save" iconCls="icon-save">确定</a>
            <a href="#"  class="easyui-linkbutton" onclick="$('#systemdictionarydetailDialog').dialog('close')" iconCls="icon-cancel">取消</a>
        </div>
    </form>
</div>
