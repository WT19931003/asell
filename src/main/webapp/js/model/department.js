$(function () {
    ...
    var departmentDialog = $('#departmentDialog'); //弹框
    ...
    window.itsource = {
        add:function(){
            ...
            //3.打开面板(绝对居中)
            departmentDialog.dialog("center").dialog('open').dialog("setTitle","添加数据");
        ...
        edit:function () {
            ...
            if(row){
                ...
                //3.打开面板(绝对居中)
                departmentDialog.dialog("center").dialog('open').dialog("setTitle","修改数据");
                //4.数据进行回显
                //if(row.department){
