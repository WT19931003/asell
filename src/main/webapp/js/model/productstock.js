$(function () {
    ...
    var productstockDialog = $('#productstockDialog'); //弹框
    ...
    window.itsource = {
        add:function(){
            ...
            //3.打开面板(绝对居中)
            productstockDialog.dialog("center").dialog('open').dialog("setTitle","添加数据");
        ...
        edit:function () {
            ...
            if(row){
                ...
                //3.打开面板(绝对居中)
                productstockDialog.dialog("center").dialog('open').dialog("setTitle","修改数据");
                //4.数据进行回显
                //if(row.department){
        ...
        save:function () {
            ...
            if(id){
                url = "/productstock/update?cmd=update"
            }
            //提交表单的功能
                ...
                success: function(result){
                   ...
                   if(result.success){
                       //成功之后的处理
                        ...
                        //关闭弹出框
                        productstockDialog.dialog('close');
                   }else{
