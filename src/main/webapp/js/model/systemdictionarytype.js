$(function () {
    ...
    var systemdictionarytypeDialog = $('#systemdictionarytypeDialog'); //弹框
    ...
    window.itsource = {
        add:function(){
            ...
            //3.打开面板(绝对居中)
            systemdictionarytypeDialog.dialog("center").dialog('open').dialog("setTitle","添加数据");
        ...
        edit:function () {
            ...
            if(row){
                ...
                //3.打开面板(绝对居中)
                systemdictionarytypeDialog.dialog("center").dialog('open').dialog("setTitle","修改数据");
                //4.数据进行回显
                //if(row.department){
        ...
        save:function () {
            ...
            //拿到表单中的id
            var id = $("#systemdictionarytypeId").val();
            if(id){
